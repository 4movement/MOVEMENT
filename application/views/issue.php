        ...
        <div id = "issue_layout" class = "layout">
            <div id = "issue" class = "wrapper">
                ...
                <div id = "world_map">
                    ...
                    <div  class = "issue_data">
                        <div class = "location">
                            ...
                            <img src="assets/img/issue/issue-button/peback01.png" class = "location"/>
                        </div>
                        <div class = "number">
                            <span class="number">4.5</span>
                            <img src="assets/img/issue/issue-button/peback02.png" class = "number"/>
                        </div>
                    </div><!--data-->
                </div>
                ...
                <div class = "issue_text">
                    ...
                    <img class = "issue_logo" src = "assets/img/issue/issue-button/nuclogo.png">
                </div>
                ...
                <div id = "issue_search_wrapper">
                    ...
                    <img id = "issue_search_button" src="assets/img/issue/issue-button/su-icon_1.png">
                </div>

                <div class = "side_bar">
                    <img class = "right_button" src = "assets/img/issue/issue-button/arr02.png">
                    <img class = "down_button" src = "assets/img/issue/issue-button/arr03.png">
                </div>

                <div class = "link_wrapper">
                    <div class = "guest_board link">
                        <span class = "link">Guest Board </span>
                        <img src = "assets/img/issue/issue-button/wba02.png" class = "link"/>
                    </div>
