...
(function($) {
    ...
    var WorldMap = function(params) {
        ...
        this.label = jQuery('<div/>').addClass('jqvmap-label').appendTo(this.container).hide();
        ...
        if (params.showTooltip) {
            params.container.mousemove(function(e) {
                if (map.label.is(':visible')) {
                    var left = e.pageX - 15 - map.labelWidth - params.container.offset().left;
                    var top = e.pageY - 15 - map.labelHeight - params.container.offset().top;

                    if (left < 0)
                        left = e.pageX + 15 - params.container.offset().left;
                    if (top < 0)
                        top = e.pageY + 15 - params.container.offset().top;
    ...
    WorldMap.prototype = {
        ...
        positionPins : function() {
            ...
            jQuery.each(pins, function(index, pinObj) {
                ...
                var left = position.left + (bbox.width / 2) * scale - pinObj.width() / 2, top = position.top + (bbox.height / 2) * scale - pinObj.height() / 2;
